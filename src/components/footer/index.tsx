...
import { Bank, Buildings, Detective, Envelope, Heart, Info, Keyhole, MapPin, Money, Pen, Phone, TrademarkRegistered, User, UsersThree } from "phosphor-react";
      ...
      <div>
        ...
        <div className="col">
          <div className="topic">
            ...
            <div>
              <NavButton color='black'><MapPin size={16} weight='fill' />R. José Barreto Parente, 190 - Luciano Cavalcante, Fortaleza - CE, 60811-160</NavButton>
              <NavButton color='black'><Phone size={16} weight='fill' /><a>+55 (85) 9 9432-3201</a></NavButton>
              <NavButton color='black'><Envelope size={16} weight='fill' /><a>ceo@empregamais.me</a></NavButton>
            </div>
          </div>
        </div>
      </div>
